...
引数に指定するテキストファイル (omikujilist.txt) はこちらで用意したものを作業フォルダにコピーしておいてください。<br>
...
```
---
引数に指定した "omikujifile.txt" から1行ずつ取り出していき、EOFを取り出したら条件を満たさないので処理を停止します。<br>
...
リストの内容に飾りを挿入してファイルを書き込むことができました。
